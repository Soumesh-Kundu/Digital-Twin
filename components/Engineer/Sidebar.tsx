    ...
    <aside className="w-64 min-h-0 shadow-md border-r p-4 pl-0">
      <div className="py-5">
        <ul className="flex flex-col  gap-3">
          <Link href="/engineer">
            <li
              className={`mb-2 flex items-center gap-2 duration-200 hover:translate-x-2  rounded-r-full pl-4 py-2.5 ${
                pathname === "/engineer" ? "bg-gray-300 translate-x-0!" : ""
              }`}
            >
              <ChartSpline />
          ...
          <Link href="/engineer/machines">
            <li
              className={`mb-2 flex items-center gap-2 duration-200 hover:translate-x-2  rounded-r-full pl-4 py-2.5 ${
                pathname === "/engineer/machines" ? "bg-gray-300 translate-x-0!" : ""
              }`}
            >
              <svg
          ...
          <Link href="/engineer/alerts">
            <li
              className={`mb-2 flex items-center gap-2 duration-200 hover:translate-x-2  rounded-r-full pl-4 py-2.5 ${
                pathname === "/engineer/alerts" ? "bg-gray-300 translate-x-0!" : ""
              }`}
            >
              <Bell />
